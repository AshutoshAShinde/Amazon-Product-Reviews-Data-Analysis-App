...
Others = ["Data Analysis App", "Source Code", "Portfolio"]
...
if choice == "Data Analysis App":
    ...
    st.subheader("[GitHub Repository](https://github.com/AshutoshAShinde/Amazon-Product-Reviews-Data-Analysis-App)")
    st.subheader("[LinkedIn Profile](https://www.linkedin.com/in/ashutoshashinde/)")
